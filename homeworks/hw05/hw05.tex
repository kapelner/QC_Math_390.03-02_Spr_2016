...
\easysubproblem{If $\alpha = 100$ and $\beta = 3$ and $n=50$. Run the following code to look at the prior predictive distribution. No need to print out the illustration.

If you now get 10 successes on your 50 observations (the red line), does this indicate a problem? Yes/No}
...
If you now get 10 successes on your 50 observations, does this indicate a problem? Yes/No}
...
Does this indicate a problem? Yes/No}
