...
\hardsubproblem{In class we discussed the \qu{principle of indifference} which is a term I borrowed from \href{http://www.amazon.com/Philosophical-Theories-Probability-Issues-Science/dp/041518276X/ref=sr_1_1?ie=UTF8&qid=1455112335&sr=8-1&keywords=donald+gillies+theory+of+probability}{Donald Gillies' Philosophical Theories of Probability}. McGrayne in her research of original sources comes up with many names for this principle. List all of them here.} \spc{3}
\end{enumerate}


\problem{More about likelihood estimators}

\begin{enumerate}

\easysubproblem{Write the PDF of $X$.}\spc{3}
\end{enumerate}
