...
\easysubproblem{Now under the informative conjugate prior:
...
what is the distribution of $\theta~|~X,~\sigsq$? The new $\theta_p$ here has a nicer form than before.}\spc{2}

\easysubproblem{What is the distribution of $\theta~|~X$? No need to derive it; just copy it from the notes.}\spc{4}

\hardsubproblem{[MA] Prove (p) above. Or prove my notes are wrong.}\spc{10}


\easysubproblem{What is the distribution of $\sigsq~|~\theta$? No need to derive it; just copy it from the notes.}\spc{4}

\hardsubproblem{[MA] Prove (r) above. Or prove my notes are wrong.}\spc{10}

\easysubproblem{Explain how to sample from the distribution of $X^*~|~X$.}\spc{4}

\easysubproblem{Guess the form of the distribution of $X^*~|~X$ given (m), (p) and (r).}\spc{4}
